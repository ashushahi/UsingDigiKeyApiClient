...
using UsingDigiKeyApiClient.Configuration.Interfaces;



namespace UsingDigiKeyApiClient.Configuration
{
    public class ApiClientConfigHelper : ConfigurationHelper, IApiClientConfigHelper
    {
        ...
        private ApiClientConfigHelper()
        {
            try
            {
                ...
                {
                    Console.WriteLine($"Unable to locate apiclient.config in solution folder {solutionDir.FullName}");
                    return;
                }
